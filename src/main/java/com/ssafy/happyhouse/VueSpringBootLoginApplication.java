...
//    JWTInterceptor를 설치한다.
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(jwtInterceptor).addPathPatterns("/happyhouse/**") // 기본 적용 경로
                .excludePathPatterns(Arrays.asList("/happyhouse/mypage/login/**", "/happyhouse/qna/**"));// 적용 제외 경로
    }
